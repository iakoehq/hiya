...
function initStuck(value) {
  ...
  var n = 0;
  // $window.scroll(function () { commented because not using stuck nav and it creating issue with header cart accnt dropdowns
...
$.fn.initSection = function () {
  ...
  switch (n) {
    ...
    case ("index_verticaltabs"): _.find('.tt-carousel-products-js').initSlick(2, 2, 1); break;
...
$(document).ready(function () {
  ...
  $(".ybtn,#s-a8daa394-f817-4634-b00a-0d031547f084, #s-3ccde251-86dd-4433-b5c5-7846df7c6eb1, #s-fa3b602c-771b-4bab-bdce-caacc201a7a2, #s-ac835cbf-61d4-489c-a99d-6c2a38f44115").click(function () {
    $('html, body').animate({
  ...
  $('.ing-modal-imagepop').magnificPopup({
    type: 'image',
